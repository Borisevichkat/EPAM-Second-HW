...
public class KettleProduct extends Product{
    ...
    public String toString() {
        return String.format("Power consumption=%f, Capacity=%f, Height=%f, Weight=%f, Price=%f",
    ...
    public static OvenProduct.Builder parseString(String[] params) {
        OvenProduct.Builder builder = new OvenProduct.Builder();
